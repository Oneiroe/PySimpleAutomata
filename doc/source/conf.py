...
# -*- coding: utf-8 -*-
#
# PySimpleAutomata documentation build configuration file,
# created by
...
project = 'PySimpleAutomata'
copyright = '2017, Alessio Cecconi'
...
html_theme_options = {
    'description': 'Library to manage DFA, NFA and AFW automata',
    'github_user': 'oneiroe',
    'github_repo': 'PySimpleAutomata',
    'fixed_sidebar': True,
...
htmlhelp_basename = 'PySimpleAutomatadoc'
...
latex_documents = [
    (master_doc, 'PySimpleAutomata.tex',
     'PySimpleAutomata Documentation',
     'Alessio Cecconi', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'PySimpleAutomata',
     'PySimpleAutomata Documentation',
     author, 'PySimpleAutomata', 'One line description of project.',
     'Miscellaneous'),
]
